...
export const variants: DemoVariant[] = [
  ...
  },
  {
    id: "input",
    name: "Input",
    description: "라벨 + 입력칸 + 설명의 기본 조합입니다. 설명은 입력칸 위에도, 아래에도 둘 수 있습니다.",
    Demo: WithInput,
  },
  {
    id: "textarea",
  ...
  },
  {
    id: "slider",
    name: "Slider",
    description: "슬라이더를 제목·설명과 함께 묶습니다. 현재 값이 설명 문장 안에 바로 표시됩니다.",
    Demo: WithSlider,
  },
  {
    id: "fieldset",
    name: "Fieldset",
    description: "관련 입력칸 여러 개를 하나의 제목(범례) 아래로 묶습니다. 주소 입력처럼 씁니다.",
    Demo: Fieldset,
  },
  {
    id: "checkbox",
  ...
  },
  {
    id: "responsive",
    name: "Responsive",
    description: "좁은 화면에서는 세로로, 넓은 화면에서는 라벨과 입력칸이 나란히 놓입니다.",
    Demo: Responsive,
  },
  {
    id: "rtl",
    name: "RTL",
    description: "아랍어처럼 오른쪽에서 왼쪽으로 읽는 언어용 배치입니다. 라벨 정렬이 뒤집힙니다.",
    Demo: Rtl,
  },
]
